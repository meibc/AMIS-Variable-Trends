...
# Combined AMIS 2 has different stigma definition: stigma only in last 6 months
df_filepath <- '/Users/meibinchen/Documents/GitHub/EEE/EEE Feb 2025/combined_amis2.csv'
...
vars <- c("stigma_ahs", "stigma_gss", "stigma_family", "knowledge_aware",
          ...
          "insur_bin", "urbrur", "out_gi", "out_gid", "out_gic", "seehcp")
...
# year_levels <- c("2015-2016", "2017-2018", "2019-2020", "2021-2022", "2023-2024")
